...
const ProfilePage = () => {
  ...
  useEffect(() => {
    // Always check auth when the component mounts
    checkAuth();
    // We don't need authUser in the dependency array as that would create a loop
  ...
  // If not checking auth anymore but still no user data, likely not logged in
  if (!authUser) {
    return (
